...
class ViewingCampaignpage extends StatefulWidget {
  const ViewingCampaignpage({Key? key}) : super(key: key);

  @override
  State<ViewingCampaignpage> createState() => _ViewingCampaignpageState();
}

class _ViewingCampaignpageState extends State<ViewingCampaignpage> {
  @override
